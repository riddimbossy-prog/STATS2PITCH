...
- **Filter Tips** — adaptive matchup (`adaptive-match-v1`). Last-5 venue attack vs defence, then scenario checks. Publishes one supported market per match inside a 1.20–2.20 price window. Does not feed Elite.
