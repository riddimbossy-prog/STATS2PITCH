...
test('Filter Tips is a dedicated public tab',async()=>{
  ...
  assert.match(js,/REQUIRED_ENGINES=new Set\\(\\['sporty-filter-v1','sporty-filter-v2','perfect-split-v1','adaptive-match-v1'\\]\\)/)
...
test('Goals Bankers is a dedicated public tab with slip rules and no method copy',async()=>{
  ...
  assert.match(js,/REQUIRED_ENGINES=new Set\(\['goals-bankers-v5\.1','goals-bankers-v5\.2','goals-bankers-v5\.3','goals-bankers-v5\.4'\]\)/)
