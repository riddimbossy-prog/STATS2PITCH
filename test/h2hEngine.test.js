...
import {analyzeH2HFixture,H2H_MIN_RATE,H2H_MIN_MATCHES} from '../server/h2hEngine.js'
const market=(id,name,outcomes)=>({id,name,outcomes:outcomes.map(([desc,odds])=>({desc,odds}))})
...
const fixture=history=>({fixtureId:99,kickoff:'2026-09-10T12:00:00Z',league:'Test',country:'GH',home:{id:1,name:'Home'},away:{id:2,name:'Away'},h2hHistory:history,sportyMarkets:[market(1,'1X2',[['Home','1.50'],['Draw','3.50'],['Away','5.00']]),market(10,'Over/Under',[['Over 2.5','1.80'],['Under 2.5','1.90']])]})
