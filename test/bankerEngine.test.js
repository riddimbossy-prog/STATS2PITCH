...
function markets({homeWin=1.45,awayWin=4.20,draw=3.80,over15=1.22,over25=1.72,under35=1.55,homeO05=1.18,awayO05=1.85,homeO15=1.55,awayO15=2.40,homeO25=1.85,awayO25=3.10,streak=1.32}={}){
  return[
...
test('streak Yes 1.25-1.40 with cheap Over 1.5 and open Under 3.5 publishes Over 1.5',()=>{
  const r=evaluateBankerFixture(fixture({homeO25:2.40,awayO25:2.50,over25:2.30,over15:1.22,under35:1.55,streak:1.30,awayO05:1.60}))
