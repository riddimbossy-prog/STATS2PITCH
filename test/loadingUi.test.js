...
test('football and pitch loader owns page boot and refresh states',async()=>{
  ...
  assert.match(html,/stats2pitch-build" content="2\.2\.0"/)
  assert.match(html,/s2p-loader--page/)
  assert.match(html,/\/assets\/football-real\.svg\?v=2\.2\.0/)
  assert.match(html,/\/assets\/brand-mark\.png\?v=2\.2\.0/)
  assert.match(html,/Loading <b>matches\.\.\.<\/b>/)
  assert.match(html,/\/runtime-config\.js\?v=2\.2\.0/)
