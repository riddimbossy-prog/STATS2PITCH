...
const baseHome={id:1,name:'Alpha',venue:'home',winRate:40,seasonWinRate:40,played:5,position:4,pointsPosition:4,positionSampleReady:true,leagueSize:10,goalsConceded:1}
...
if(out.priority[0]?.market!=='1X2')throw new Error('Opponent conceding above 2.30 in the relevant split must allow the exception after hard gates pass')
