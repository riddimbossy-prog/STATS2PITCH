...
const baseTeam={id:1,name:'Alpha',venue:'home',position:5,overallPosition:2,leagueSize:8,played:5,seasonWinRate:20,overallPlayed:10,ppg:.8,goalsScored:.8,goalsConceded:1.6,winRate:40,lossRate:60,winRate10:70,lossRate10:30,formAgreement:'NEUTRAL',over15:80,under15:20,over25:80,under25:20,over35:40,under35:60,cleanSheetRate:40,failedToScoreRate:40,bttsRate:40}
...
const splitStrong={...baseTeam,position:2,overallPosition:8,ppg:2.2,seasonWinRate:80,winRate:80,lossRate:0,failedToScoreRate:0}
...
const splitBottom={...splitStrong,position:6,overallPosition:1,winRate:100,seasonWinRate:100,ppg:3,goalsScored:3}
...
console.log(JSON.stringify({ok:true,policy:SPLIT_ENGINE_POLICY,t1Overall:t1.overallPosition,t1Home:t1.position,t1HomeSeasonWinRate:t1.seasonWinRate,last5HomeWinRate:venueForm.winRate,last10HomeWinRate:venueForm.winRate10},null,2))
