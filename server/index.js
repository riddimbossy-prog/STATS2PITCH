...
const VERSION='2.0.1',PORT=Number(process.env.PORT||3000),PUBLIC=fileURLToPath(new URL('../public/',import.meta.url)),ttlMs=Math.max(5,Number(process.env.AUTO_REFRESH_TTL_MINUTES||45))*60000
