const CACHE='stats2pitch-shell-v5.5.0'
const SHELL=['/','/filter-tips.html','/var-tips.html','/goals-bankers.html','/results.html','/offline.html','/conceptD.css','/mobile2026.css','/filterTips.css','/varTips.css','/goalsBankers.css','/leagueFlags.js','/appCrests.js','/filterTips.js','/varTips.js','/goalsBankers.js','/net.js','/crests.js','/whyPopup.js','/pwa.js','/assets/stats2pitch-favicon-v2.png','/assets/football-real.svg']
